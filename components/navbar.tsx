...
export default function NavBar() {
  return (
    <div
      className={`flex items-center justify-start text-2xl z-40 text-white border-t-[7px] border-black bg-gradient-to-r from-fuchsia-900 to-fuchsia-500 h-[12vh]`}
    >
      ...
      <a className={`h-full items-center flex px-4`}>Build {process.env.VERSION}</a>
    </div>
  );
}
